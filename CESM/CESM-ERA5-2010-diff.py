...
fig.savefig(pappath + 'paper-CESM-ERA5-2010-IC-diff.png',dpi=300,bbox_inches='tight')
plt.close('all')
...
fig.savefig(pappath + 'paper-CESM-ERA5-2010-stratification-diff.png',dpi=300,bbox_inches='tight')
plt.close('all')
...
#
#
#fig.savefig(pappath + 'paper-CESM-ERA5-2010-diff_06-00.png',dpi=300,bbox_inches='tight')
#plt.close('all')
