...
simsb=['CESM-2040-DJF-0-km-max-','CESM-2070-DJF-0-km-max-']
...
for samp,wamp,qamp in zip(['weak','moderate','strong'],[11,22,34],['0.7','1.4','2.1']):
    ...
    ax = fig.get_axes()[5]
    ax.text(0.02,1.02,'C2070 perturbation amplitude = %d m s$^{-1}$'%wamp, transform=ax.transAxes)
    
    ax = fig.get_axes()[0]
    ax.text(0.02,1.02,'C2040 perturbation amplitude = %d m s$^{-1}$'%wamp,transform=ax.transAxes)
    
    fig.savefig(pappath + 'CESM-SC-MC-%s-pertub-PV-evo.png'%samp,dpi=300,bbox_inches='tight')
    plt.close('all')
...
for samp,wamp,qamp in zip(['weak','moderate','strong'],[11,22,34],['0.7','1.4','2.1']):
    ...
    ax = fig.get_axes()[0]
    ax.text(0.02,1.02,'C2100 perturbation amplitude = %d m s$^{-1}$'%wamp,transform=ax.transAxes)

    fig.savefig(pappath + 'CESM-EC-%s-pertub-PV-evo.png'%samp,dpi=300,bbox_inches='tight')
    plt.close('all')
