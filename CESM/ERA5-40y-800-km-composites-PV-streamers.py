...
labels=['(a) E42 weak','(b) E42 moderate','(c) E42 strong']
for se in seas[:1]:
...
#   qk.set_bbox(dict(facecolor='white',edgecolor='white'))
   ...
   gfig.savefig('/atmosdyn2/ascherrmann/015-CESM-WRF/ERA5-40y-800-km-PV-streamer-composites.png',dpi=300,bbox_inches='tight')
   plt.close(gfig)
