...
for sea in seasons[:1]:
 for q,perio in enumerate(period):
    ...
    ref = ds(wrfd + 'CESM-%s-DJF-clim/wrfout_d01_2000-12-01_00:00:00'%perio,'r')
    Uref = ref.variables['U'][0,:]
    Pref = wrf.getvar(ref,'pressure')
    
    if perio=='2070':
    
        per = ds(wrfd + 'CESM-2100-DJF-0-km-max-2.1-QGPV/wrfout_d01_2000-12-01_00:00:00','r')
    elif perio=='2100':
        per = ds(wrfd + 'CESM-2100-DJF-0-km-max-2.1-QGPV-jet-check/wrfout_d01_2000-12-01_00:00:00','r')
    else:
        per = ds(wrfd + 'CESM-%s-DJF-0-km-max-2.1-QGPV/wrfout_d01_2000-12-01_00:00:00'%perio,'r')
...
Fig.savefig(pappath + 'CESM-ICs-PV-TH-check.png',dpi=300,bbox_inches='tight')
plt.close('all')
