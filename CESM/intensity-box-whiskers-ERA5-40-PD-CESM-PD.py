...
### MED
labels=np.array(['E42','E2010','C2010'])#,'CESM SC','CESM MC','CESM EC'])#,'CESM EC'])
...
f = open('/atmosdyn2/ascherrmann/015-CESM-WRF/delta-SLP-track-ERA5-paper.txt','rb')
...
fig.savefig('/atmosdyn2/ascherrmann/015-CESM-WRF/images/box-plots-ERA5-40y-PD-CESM-PD.png',dpi=300,bbox_inches='tight')
plt.close('all')
