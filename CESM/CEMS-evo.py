...
for samp,wamp,qamp in zip(['weak','moderate','strong'],[11,22,34],['0.7','1.4','2.1']):
    ...
    ax = fig.get_axes()[5]
    ax.text(0.02,1.02,'C2010 perturbation amplitude = %d m s$^{-1}$'%wamp, transform=ax.transAxes)
    
    ax = fig.get_axes()[0]
    ax.text(0.02,1.02,'E2010 perturbation amplitude = %d m s$^{-1}$'%wamp,transform=ax.transAxes)
