...
f.close()
trackdens = dict()
for row,perio in enumerate(['2040','2070','2100']):
...
figg.savefig('/atmosdyn2/ascherrmann/015-CESM-WRF/images/trackdens-CESM-SC-MC-EC-%s.png'%sea,dpi=300,bbox_inches="tight")
