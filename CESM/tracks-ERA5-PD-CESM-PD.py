...
labels2= ['E2010','C2010','C2040','C2070','C2100']
figg=plt.figure(figsize=(10,8/3*2))
fig=plt.figure(figsize=(10,8/3*2))
fi=plt.figure(figsize=(10,8/3*2))
...
ax = figg.get_axes()[-2]
pos = ax.get_position()
cax = figg.add_axes([pos.x0-pos.width/4,pos.y0-0.09,pos.width*1.5,0.02])
cbar = plt.colorbar(cf,cax=cax,orientation='horizontal')
cbar.ax.set_xticklabels(np.append(denslvl[:-1],'%'))

figg.savefig('/atmosdyn2/ascherrmann/015-CESM-WRF/images/trackdens-ERA5-PD-CESM-PD-%s.png'%sea,dpi=300,bbox_inches="tight")
