...
inp="/net/thermo/atmosdyn2/ascherrmann/015-CESM-WRF/"
memb="0900"
out=${inp}
...
#	ncap2 -t 2 -s 'P[time,lev,lat,lon]=(hyam*1000 + hybm*PS); RH=(0.263 * P * Q/(exp(17.67 * (T-273.16)/(T-29.65)))); where(RH>100) RH=100;' time-sel-${y}.nc RH-${y}.nc	
#
#	rm time-sel-${y}.nc
