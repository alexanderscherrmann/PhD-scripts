...
Labels=[['(a) E2010','(b) E2010','(c) E2010'],['(d) C2010','(e) C2010','(f) C2010'],['(g) C2040','(h) C2040','(i) C2040'],['(j) C2070','(k) C2070','(l) C2070'],['(m) C2100','(n) C2100','(o) C2100']]
...
for ax in axes[2::3]:
    ...
    cbar=plt.colorbar(u, ticks=ulevels,cax=cbax)
...
Fig.savefig(pappath + 'CESM-ICs-overview.png',dpi=300,bbox_inches='tight')
plt.close('all')
