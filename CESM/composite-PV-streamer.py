...
#                avv+=v300
          ...
          #  ax.set_ylim(20,65)
            ...
            tex=axx.text(-17.7,60,'%s %s %s'%(labels[wq*3+qq],labels2[wq],ampl),zorder=15,fontsize=8)
    ...
    #    qk.set_bbox(dict(facecolor='white',edgecolor='white'))
        ...
        gfig.savefig('/atmosdyn2/ascherrmann/015-CESM-WRF/%s-med-streamer-composites-%s-300hPa.png'%(perio,t),dpi=300,bbox_inches='tight')
        plt.close(gfig)
...
fullfig.savefig('/atmosdyn2/ascherrmann/015-CESM-WRF/DJF-all-streamer-composites-%s-300hPa.png'%t,dpi=300,bbox_inches='tight')
...
fullfig.savefig('/atmosdyn2/ascherrmann/015-CESM-WRF/DJF-300hPa-height-%s.png'%t,dpi=300,bbox_inches='tight')
plt.close('all')
...
#                    p = wrf.getvar(data,'pressure')
                ...
                hz = f2ax.contourf(LON[0],LAT[:,0],avz/counter,levels=zl,cmap=matplotlib.cm.nipy_spectral)
                fax.contourf(LON[0],LAT[:,0],avpv/counter,levels=pvlevels,cmap=pvcmap,norm=pvnorm)
                tex=ax.text(-17.7,60,'%s %s %s'%(labels[wq*3+qq],labels2[wq],ampl),zorder=15,fontsize=8)
        ...
        #    qk.set_bbox(dict(facecolor='white',edgecolor='white'))
            ...
            gfig.savefig('/atmosdyn2/ascherrmann/015-CESM-WRF/%s-med-streamer-composites-%s-%dK.png'%(perio,t,THl),dpi=300,bbox_inches='tight')
            plt.close(gfig)
    ...
    fullfig.savefig('/atmosdyn2/ascherrmann/015-CESM-WRF/DJF-all-streamer-composites-%s-%dK.png'%(t,THl),dpi=300,bbox_inches='tight')
    fullfig2.subplots_adjust(hspace=0,wspace=0)
    axes = fullfig2.get_axes()[2::3]
    for fax in axes:
            pos=fax.get_position()
