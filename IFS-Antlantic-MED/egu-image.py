...
maxv = 1.5
minv =0
pvr_levels = np.arange(minv,maxv,0.5)
...
#    norm=BoundaryNorm(np.array([0,0.5,1]),cmap.N)
...
#        z = pvr[q,matureid-1:matureid+1]
        z = data['dit'][date]['cyc'][q,matureid-1:matureid+1]
...
#    figname = pload + 'traj-pvr-' + str(date)  + '-interview3.png'
    figname = pload + 'traj-pvr-' + str(date)  + '-egu.png'
