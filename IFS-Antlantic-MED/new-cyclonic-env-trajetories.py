...
ax.text(0.025, 0.975, 'a)', transform=ax.transAxes,fontsize=12, fontweight='bold', va='top')
...
pf = xr.open_dataset('/home/ascherrmann/010-IFS/data/DEC17/P20171214_02')
...
fig.savefig('/home/ascherrmann/010-IFS/inside-cyclone-explaination.png',dpi=300,bbox_inches="tight")
plt.close(fig)
...
a2,=axes[0].plot([],[],ls=' ',marker='s',color='k')
a3,=axes[0].plot([],[],ls='-',color='k')
a4,=axes[0].plot([],[],ls=':',color='k')
...
#    ax.plot(datadi['20171214_02-073']['time'][0],np.flip(np.cumsum(np.flip(deltaPV))),color='grey')
    ...
    ax.text(-0.10, 0.95, lab[q],transform=ax.transAxes,fontsize=12, fontweight='bold', va='top')
    ...
    #ax.scatter(datadi['20171214_02-073']['time'][0,envids],datadi['20171214_02-073']['PV'][k,envids],color=colors1[q],marker='s',s=15.)
    ax.set_ylim(-0.7,2.5)
...
axes[1].legend([lc1,a1,a3,a4],['PV','inside cyclone','apvc','apve'],loc='upper left',frameon=False,handler_map={lc1: HandlerColorLineCollection(numpoints=3)})
axes[2].legend(['apvo'],loc='upper left',frameon=False)
ax.set_xlabel('time from mature stage [h]')
#ax.set_ylabel('PV [PVU]')
fig.savefig('/home/ascherrmann/010-IFS/edu-env-cycPV-400-2.png',dpi=300,bbox_inches="tight")
plt.close('all')
