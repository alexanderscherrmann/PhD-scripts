...
for se in seas[:1]:
  for t in ['03_00','03_12','04_00','04_12','05_00','05_12','06_00','06_12','07_00','07_12','08_00','08_12','09_00'][3:4]:
   ...
   for amp in amps:
    ...
    full3d=np.zeros((9,ref.variables['T'][0,0].shape[0],ref.variables['T'][0,0].shape[1]))
    qwp = 0 
...
#        print(sim)
    ...
    fig.savefig('/atmosdyn2/ascherrmann/paper/NA-MED-link/composites-normal-runs-med-streamer/strength-vari-normal-runs-med-streamer-%s-%s-%.1f.png'%(t,se,amp),dpi=300,bbox_inches='tight')
    plt.close(fig)
   ...
   gfig.savefig('/atmosdyn2/ascherrmann/paper/NA-MED-link/composites-normal-runs-med-streamer/strength-vari-normal-runs-med-streamer-%s-%s.png'%(t,se),dpi=300,bbox_inches='tight')
   plt.close(gfig)
