...
for simid, sim in enumerate(SIMS):
    ...
    if sim!='DJF-clim-max-U-at-300-hPa-0.7-QGPV' and sim!='DJF-clim-max-U-at-300-hPa-1.4-QGPV' and sim!='DJF-clim-max-U-at-300-hPa-2.1-QGPV' and sim!='DJF-200-km-east-from-max-300-hPa-1.4-QGPV' and sim!='DJF-200-km-north-from-max-300-hPa-1.4-QGPV' and sim!='DJF-200-km-south-from-max-300-hPa-1.4-QGPV' and sim!='DJF-200-km-west-from-max-300-hPa-1.4-QGPV' and sim!='DJF-200-km-east-from-max-300-hPa-2.1-QGPV' and sim!='DJF-200-km-north-from-max-300-hPa-2.1-QGPV' and sim!='DJF-200-km-south-from-max-300-hPa-2.1-QGPV' and sim!='DJF-200-km-west-from-max-300-hPa-2.1-QGPV':
        continue
...
fig.savefig('/atmosdyn2/ascherrmann/paper/NA-MED-link/sppt-NA-MED-SLP.png',dpi=300,bbox_inches='tight')
plt.close(fig)
...
ax1.set_xlim(-80,50)
ax1.set_ylim(20,80)
fig1.savefig('/atmosdyn2/ascherrmann/paper/NA-MED-link/sppt-MED-mature-position.png',dpi=300,bbox_inches='tight')
plt.close(fig1)
