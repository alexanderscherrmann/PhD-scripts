...
#    ax.set_extent([-120,80,20,80])
    figg.savefig(pappath + 'DJF-0.7-AT-MED-horizontal-cyclone-tracks.png',dpi=300,bbox_inches='tight')
    plt.close(figg)
axx.set_xlabel('Atlantic cyclone intensity [hPa]')
axx.set_ylabel('Med cyclone intensity [hPa]')
fig.savefig(pappath + 'DJF-0.7-horizontal-intensity-scatter.png',dpi=300,bbox_inches='tight')
