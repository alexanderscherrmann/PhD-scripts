...
sims=['MAM-clim','MAM-clim-max-U-at-300-hPa-1.4-QGPV']
...
fig.savefig(pappath + 'MAM-ref-1.4-dynamics.png',dpi=300,bbox_inches='tight')
plt.close('all')
...
labels=['(a)','(b)','(c)','(d)','(e)','(f)','(g)','(h)','(i)','(j)']
times=['01_00','03_00','05_00','07_00','09_00']
sims=['MAM-clim-max-U-at-300-hPa-0.7-QGPV','MAM-clim-max-U-at-300-hPa-2.1-QGPV']
...
fig.savefig(pappath + 'MAM-0.7-2.1-dynamics.png',dpi=300,bbox_inches='tight')
plt.close('all')
