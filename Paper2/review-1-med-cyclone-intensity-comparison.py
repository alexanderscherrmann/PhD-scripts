...
ticklabels=['4N-strong','4N-mod','2W-mod','2E-mod','C-mod']
#lcol = ['grey','k','plum','purple','cyan','b','orange','r','saddlebrown']
lcol=['k','b','gold','purple','slategrey']
...
sims=['DJF-400-km-north-from-max-300-hPa-2.1-QGPV','DJF-400-km-north-from-max-300-hPa-1.4-QGPV','DJF-200-km-west-from-max-300-hPa-1.4-QGPV','DJF-200-km-east-from-max-300-hPa-1.4-QGPV','DJF-clim-max-U-at-300-hPa-1.4-QGPV']
...
ax3.set_xticklabels(['20$^{\circ}$W','10$^{\circ}$W','0$^{\circ}$E','10$^{\circ}$E','20$^{\circ}$E','30$^{\circ}$E','40$^{\circ}$E'])
...
fig.savefig(pappath + 'similar-med-intensity-different-at-intensity.png',dpi=300,bbox_inches='tight')
plt.close('all')
