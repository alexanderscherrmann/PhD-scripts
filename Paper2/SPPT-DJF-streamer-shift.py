...
marker=['p','d','s','+']
simc = ['%03d'%x for x in range(1,11)]
simc = np.append('clim-max',np.array(simc))
ticklabels=['C','01','02','04','04','05','06','07','08','09','10']
lcol = ['saddlebrown','grey','k','plum','purple','cyan','b','orange','r','lime','green']
...
for amp in ['0.7','1.4','2.1']:
 ...
 fig.savefig(pappath + 'DJF-SPPT-%s-streamer-ridge.png'%amp,dpi=300,bbox_inches='tight')
 plt.close('all')
