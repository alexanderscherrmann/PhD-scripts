...
name = pappath + 'nested-DJF-NA-MED-cyclone-intensity-max-PV-full-onecolor.png'
...
figg.savefig(pappath + 'nested-DJF-NA-deepning-MED-cyclone-intensity.png',dpi=300,bbox_inches='tight')
plt.close(figg)
...
#ax.legend(['NA cyclone','MED cyclone'],loc='upper right')
name = pappath + 'nested-only-DJF-NA-MED-cyclone-intensity-max-PV-full.png'
fig.savefig(name,dpi=300,bbox_inches='tight')
plt.close(fig)
