...
Labels=[['(a) Winter','(b) Winter','(c) Winter'],['(d) Spring','(e) Spring','(f) Spring'],['(g) Summer','(h) Summer','(i) Summer'],['(j) Autumn','(k) Autumn','(l) Autumn']]
...
Fig.savefig(pappath + 'all-clim-IC-with-JJA-overview.png',dpi=300,bbox_inches='tight')
plt.close('all')
