...
for simid, sim in enumerate(SIMS):
    ...
    tgen = t[loc[0]]
    tsim = helper.simulation_time_to_day_string(tgen)
...
#    PV300=np.ones((LAT.size,LON.size))
...
for sea in ['DJF','MAM','SON']:
    ...
    fi[sea].savefig(image+ sea + '-streamer-genesis-maps.png',dpi=300,bbox_inches='tight')
