...
fig.savefig(pappath + 'paper-SON-MAM-IC-diff.png',dpi=300,bbox_inches='tight')
plt.close('all')
...
fig.savefig(pappath + 'paper-SON-MAM-stratification-diff.png',dpi=300,bbox_inches='tight')
plt.close('all')
