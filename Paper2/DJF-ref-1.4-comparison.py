...
ax = fig.get_axes()[0]
ax.text(0.01,1.02,'Winter climatology', transform=ax.transAxes)

ax = fig.get_axes()[5]
ax.text(0.01,1.02,'Winter pertubration amplitude = 22 m s$^{-1}$',transform=ax.transAxes)

fig.savefig(pappath + 'DJF-ref-1.4-comparison-dynamics.png',dpi=300,bbox_inches='tight')
plt.close('all')
