...
times=['03_00','04_00','05_00','06_00','07_00']
#sims=['SON-clim-max-U-at-300-hPa-1.4-QGPV','MAM-clim-max-U-at-300-hPa-1.4-QGPV']
...
for k,sim in enumerate(sims):
    ...
    for l,t in enumerate(times):
        ...
        if t!='01_00':# or t=='05_00' or t=='07_00' or t=='09_00':
            loc=np.where(ID==1)[0]
...
ax = fig.get_axes()[0]
ax.text(0.01,1.02,'winter 4N moderate', transform=ax.transAxes)

ax = fig.get_axes()[5]
ax.text(0.01,1.02,'winter 4W moderate',transform=ax.transAxes)
ax=fig.get_axes()[10]
ax.text(0.01,1.02,'winter 4N strong',transform=ax.transAxes)

fig.savefig(pappath + 'review-1-evo-comp.png',dpi=300,bbox_inches='tight')
plt.close('all')
