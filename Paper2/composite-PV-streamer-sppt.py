...
for se in seas:
  for amp in amps:
    ...
    fig.savefig('/atmosdyn2/ascherrmann/paper/NA-MED-link/sppt-med-streamer-genesis-%s-%.1f.png'%(se,amp),dpi=300,bbox_inches='tight')
    plt.close('all')
...
for se in seas:
  for amp in amps:
    ...
    fig.savefig('/atmosdyn2/ascherrmann/paper/NA-MED-link/sppt-med-streamer-mature-%s-%.1f.png'%(se,amp),dpi=300,bbox_inches='tight')
    plt.close('all')
