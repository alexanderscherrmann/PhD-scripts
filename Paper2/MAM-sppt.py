...
for simid, sim in enumerate(SIMS):
    ...
    if sim!='MAM-clim-max-U-at-300-hPa-0.7-QGPV' and sim!='MAM-clim-max-U-at-300-hPa-1.4-QGPV' and sim!='MAM-clim-max-U-at-300-hPa-2.1-QGPV':
        continue
...
fig.savefig('/atmosdyn2/ascherrmann/paper/NA-MED-link/sppt-MAM-NA-MED-SLP.png',dpi=300,bbox_inches='tight')
plt.close(fig)
...
ax1.set_xlim(-80,50)
ax1.set_ylim(20,80)
fig1.savefig('/atmosdyn2/ascherrmann/paper/NA-MED-link/sppt-MAM-MED-mature-position.png',dpi=300,bbox_inches='tight')
plt.close(fig1)
