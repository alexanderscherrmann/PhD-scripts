...
for pvpo,sea in zip(pvpos,seasons[:1]):
    ...
    per = ds(wrfd + 'DJF-clim-max-U-at-300-hPa-1.4-QGPV-check/wrfout_d01_2000-12-01_00:00:00')
...
#    cbar.ax.set_yticklabels(labels=np.append(ulevels[:-1],'m s$^{-1}$'))
    ...
    fig.savefig(pappath + 'DJF-1.4-check-IC-overview_contours.png',dpi=300,bbox_inches='tight')
    plt.close('all')
