...
cbax = fig.add_axes([x0+pos.width/2, pos.y0-0.07, pos.width, 0.02])
...
ax = fig.get_axes()[0]
ax.text(0.01,1.02,'Winter pertubration amplitude = 11 m s$^{-1}$',transform=ax.transAxes)

ax = fig.get_axes()[2]
ax.text(0.01,1.02,'Winter pertubration amplitude = 34 m s$^{-1}$',transform=ax.transAxes)

fig.savefig(pappath + 'reduced-DJF-0.7-2.1-dynamics.png',dpi=300,bbox_inches='tight')
plt.close('all')
