...
amps = [0.7, 1.4, 2.1, 2.8, 3.5, 4.2,0.9,1.7,1.1]
...
for simid, sim in enumerate(SIMS):
    ...
    ax3.scatter(aminslp,genesis,color=col,marker=mark,s=amp*10-3)
    ax.scatter(maxpv,slpmin,color=col,marker=mark,s=amp*10-3)
    
ax.set_xlabel('max PV inside anomaly [PVU]')
ax.set_ylabel('MED cyclone min SLP [hPa]')
ax.legend(legend,loc='upper right')
name = dwrf + 'image-output/non-errorbar-MED-cyclone-PV-anomaly-SLP-scatter-min-of-all-tracks-in-MED.png'
...
name = dwrf + 'image-output/non-errorbar-Atlantic-MED-cyclone-SLP-scatter-min-of-all-tracks-in-MED.png'
...
name = dwrf + 'image-output/non-errorbar-MED-cyclone-genesis-time-scatter-min-of-all-tracks-in-MED.png'
