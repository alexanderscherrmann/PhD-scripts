...
SIMS,ATIDS,MEDIDS = wrfsims.secondary_cyclone_ids()
SIMS = np.array(SIMS)
rein = np.array(wrfsims.reinforcement())
...
#markers=['o','o','o','o','x','+']
legend=['DJF','MAM','JJA','SON','DJF-200km','DJF-300km','DJF-500km','low-tropo-only']
...
name = dwrf + 'image-output/secondary-MED-cyclone-PV-anomaly-SLP-scatter-min-of-all-tracks-in-MED.png'
...
name = dwrf + 'image-output/secondary-Atlantic-MED-cyclone-SLP-scatter-min-of-all-tracks-in-MED.png'
...
name = dwrf + 'image-output/secondary-MED-cyclone-genesis-time-scatter-min-of-all-tracks-in-MED.png'
...
name = dwrf + 'image-output/secondary-MED-cyclone-Atlantic-deepening-6h-scatter-min-of-all-tracks-in-MED.png'
