...
f = open(ps + 'premature-ridge-streamer-types-%.1f-%d-more-than-%d-in-%d-%d.txt'%(checkval,minn,mth,gth,lth),'wb')
pickle.dump(overlap,f)
f.close()


f = open(ps + 'premature-streamer-types-%.1f-%d-more-than-%d-in-%d-%d.txt'%(checkval,minn,mth,gth,lth),'wb')
