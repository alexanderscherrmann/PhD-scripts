...
f = open(ps + 'SON-general-types-%.1f-ridge-streamer-types-%.1f.txt'%(sizecheck,checkval),'wb')
pickle.dump(overlap,f)
f.close()


f = open(ps + 'SON-general-types-size-%.1f-streamer-types-%.1f.txt'%(sizecheck,checkval),'wb')
