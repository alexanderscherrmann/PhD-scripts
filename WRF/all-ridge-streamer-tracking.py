...
while le<400:
    ...
    for dirs in os.listdir(ps):
      ...
      if le==0 and int(dirs)==325832:
          ...
          refs = ds(ps + '325832/300/old-mask.nc','r')
...
f = open(ps + 'mature-ridge-streamer-types-%.1f-%d-more-than-%d-in-%d-%d.txt'%(checkval,minn,mth,gth,lth),'wb')
pickle.dump(overlap,f)
f.close()


f = open(ps + 'mature-streamer-types-%.1f-%d-more-than-%d-in-%d-%d.txt'%(checkval,minn,mth,gth,lth),'wb')
