...
lab = [r'APV',r'APV$_{\mathrm{TOT}}$','RES',r'APV$_{\mathrm{CONVT}}$',r'APV$_{\mathrm{TURBT}}$',r'APV$_{\mathrm{CONVM}}$',r'APV$_{\mathrm{TURBM}}$',r'APV$_{\mathrm{MP}}$',r'APV$_{\mathrm{RAD}}$']
...
#fig.savefig('/atmosdyn2/ascherrmann/010-IFS/' + 'dominant-process-traj.png',dpi=300,bbox_inches="tight")
#plt.close('all')
...
ax.text(0.03, 0.95, '(a)', transform=ax.transAxes,fontsize=14,va='top')
fig.savefig('/atmosdyn2/ascherrmann/paper/cyc-env-PV/' + CT + '-dominant-mean-traj.png',dpi=300,bbox_inches="tight")
plt.close('all')
...
ax.text(0.03, 0.95, '(b)', transform=ax.transAxes,fontsize=14, va='top')
...
#
ax = axes[1]
ax.text(0.03, 0.95, '(c)', transform=ax.transAxes,fontsize=14, va='top')
...
#axes[1].set_xticklabels(labels=lab)

plt.subplots_adjust(left=0.1,hspace=0.0,wspace=0)
fig.savefig('/atmosdyn2/ascherrmann/paper/cyc-env-PV/' + CT + '-dominant-mean-cyc-env.png',dpi=300,bbox_inches="tight")
plt.close('all')
