...
ax.scatter(lonm,latm,marker='o',color='k',s=40,zorder=100)
...
circ2 = patch.Circle((lonm,latm),helper.convert_radial_distance_to_lon_lat_dis(200),edgecolor='k',facecolor='none',linestyle='--',linewidth=1.5,zorder=10.)
circ1 = patch.Circle((lonm,latm),helper.convert_radial_distance_to_lon_lat_dis(400),edgecolor='k',linestyle='-',facecolor='None',linewidth=1.5,zorder=10.)

ax.add_patch(circ1)
ax.add_patch(circ2)    

figname = 'traj-pvr-zorbas.png'
fig.savefig('/atmosdyn2/ascherrmann/paper/cyc-env-PV/' + figname,dpi=300,bbox_inches="tight")
plt.close('all')
