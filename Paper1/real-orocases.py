...
cf = ax.contour(LON,LAT,counter2,linewidths=[0.75,1.5,0.5,0.5,1.5,0.5,0.5],colors='blue',levels=levels)
#plt.clabel(cf,inline=True,fontsize=6,fmt='%d',manual=True)

fig.savefig('/atmosdyn2/ascherrmann/paper/cyc-env-PV/oro-cyclones.png',dpi=300,bbox_inches='tight')
plt.close(fig)

dfo.to_csv('/atmosdyn2/ascherrmann/009-ERA-5/MED/orocyclones.csv',index=False)
