...
ID = df['ID'].values
perc=0.5
for ano in ['cycperano','envperano']:
    t = np.arange(-120,121)
    ...
    fig.savefig('/atmosdyn2/ascherrmann/paper/cyc-env-PV/%s-cyclone-statistics-ERA5-%d-%.1f.png'%(ano,hcyc,perc),dpi=300,bbox_inches="tight")
    plt.close('all')
