...
df = df.loc[df['ntrajgt1.5PVU']>=200]
hcyc = 0
...
axes[0].text(0.03, 0.95, '(a)', transform=axes[0].transAxes,fontsize=14,va='top')
...
fig.savefig('/atmosdyn2/ascherrmann/paper/cyc-env-PV/review/cyclone-statistics-ERA5-%d-1.5PVU.png'%hcyc,dpi=300,bbox_inches="tight")
plt.close('all')
