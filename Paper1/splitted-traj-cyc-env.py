...
parser.add_argument('hcyc',default=0,type=int,help='')
...
fig.savefig('/atmosdyn2/ascherrmann/paper/cyc-env-PV/review/noro-env-cyc-PV-lines-mean-t-%d-dis-%d-%s.png'%(hcyc,rdis,thresh),dpi=300,bbox_inches="tight")
