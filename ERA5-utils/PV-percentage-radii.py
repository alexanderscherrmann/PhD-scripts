...
#  axes.set_ylim(0,1)
#  name = 'cyclonic-abs-PV-percentage-' + date + '.png'
...
axes.set_ylabel('absolute cyclonic PV modification [%]')
axes.set_xlabel('distance considered cyclonic [km]')
...
axes.set_ylim(0,100)
name = 'PV-percentage-400-6hours-correct-distance.png'
