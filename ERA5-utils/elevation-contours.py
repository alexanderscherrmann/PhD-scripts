...
pvr_levels = np.arange(minv,maxv,400)
data = xr.open_dataset(pload + 'NORO')
ap = plt.cm.BrBG
...
lc=ax.contour(lon,lat,ZB,levels=pvr_levels,linewidths=0.5,colors='black')#,cmap=cmap,extend='both',norm=norm)
