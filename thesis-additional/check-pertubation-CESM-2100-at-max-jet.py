...
#    os.system('module load dyn_tools;module load conda/2022;source activate iacpy3_2022; bash /atmosdyn2/ascherrmann/scripts/WRF/pvinv-cart/CESM-CESM-check-jet-automatic.sh %s %d %d %d %s %s %s'%(sea,int(xmax+1),int(ymax+1),int(ght[zmax,ymax,xmax]),'max',0,perio))
...
#            os.system('module load dyn_tools;module load conda/2022;source activate iacpy3_2022; bash /atmosdyn2/ascherrmann/scripts/WRF/pvinv-cart/CESM-CESM-check-jet-automatic.sh %s %d %d %d %s %s %s'%(sea,int(xtmp),int(ytmp),int(ztmp),n,k,perio))
