...
fig.savefig('/home/ascherrmann/thesis-images/' + name,dpi=300,bbox_inches="tight")
plt.close() 
...
h = axes.hist2d(abs(yal),zbb,range=[ylim,[0,2400]],cmin=10,norm=matplotlib.colors.LogNorm(),bins=nbin,cmap='cubehelix')
